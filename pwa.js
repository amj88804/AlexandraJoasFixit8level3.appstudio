...
const cacheName = 'Fixit8Level3AJoas-2020-10-03 12:50:00.011203'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit8Level3AJoas'.length) === 'Fixit8Level3AJoas') {
